...
def _rank_from_str(value):
    value = str(value)
    if value not in C.RANKS:
        raise ValueError(value)
    return value
...
SETTING_SPECS = {
    ...
    "rank_select": SettingSpec("rank", _rank_from_str, C.DEFAULT_RANK),
}
PRESET_KEYS = {"network": "network_select", "side": "side_slider", "obstacle_pct": "obstacle_slider", "seed": "seed_input", "width": "width_select", "rank": "rank_select"}
